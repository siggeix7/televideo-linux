...
METEO_SECTION_REFRESH_SECONDS = int(os.environ.get("METEO_SECTION_REFRESH_SECONDS", "9000"))
...
OPENWEATHER_REFRESH_CHECK_SECONDS = int(os.environ.get("OPENWEATHER_REFRESH_CHECK_SECONDS", "9000"))
OPENWEATHER_CITY_INTERVAL_SECONDS = int(os.environ.get("OPENWEATHER_CITY_INTERVAL_SECONDS", "9000"))
OPENWEATHER_STALE_SECONDS = int(os.environ.get("OPENWEATHER_STALE_SECONDS", "43200"))
OPENWEATHER_CITY_INTERVAL_SECONDS = int(os.environ.get("OPENWEATHER_CITY_INTERVAL_SECONDS", "600"))
OPENWEATHER_MAX_CALLS_PER_MINUTE = int(os.environ.get("OPENWEATHER_MAX_CALLS_PER_MINUTE", "40"))
OPENWEATHER_BATCH_SIZE = int(os.environ.get("OPENWEATHER_BATCH_SIZE", str(OPENWEATHER_MAX_CALLS_PER_MINUTE)))
