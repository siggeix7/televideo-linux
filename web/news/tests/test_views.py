...
class ViewTests(TestCase):
    ...
    def test_weather_page_uses_openweather_only_when_key_configured(self):
        ...
        self.assertContains(response, "capital-marker__glyph")
        self.assertContains(response, "data-capital-hovercard")
        ...
        self.assertEqual(html.count('<article class="capital-hovercard" data-capital-hovercard'), 1)
        self.assertNotContains(response, "data-card-for")
